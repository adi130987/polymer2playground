...
* **Basic Polymer 2 element**. Ggreeting element.
* **Advanced elements**. A page called `Company Employees` where you can add/edit/delete employee data.
* **DexieJs** is used to store the date.
